...
function EditPasswordScreen({ navigation }) {
  ...
  const [newPassword, setNewPassword] = useState('asdf');
  const [confirmNewPassword, setConfirmNewPassword] = useState('asdf');
    ...
    <ScrollView style={styles.all}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.button}>
          ...
          <TouchableOpacity style={styles.icon} onPress={() => { setCurrentPassword(''); }}>
            <Image source={xIcon} />
          </TouchableOpacity>
        </View>
        <View style={styles.button}>
          ...
          <TouchableOpacity style={styles.icon} onPress={() => { setNewPassword(''); }}>
            <Image source={xIcon} />
          </TouchableOpacity>
        </View>
        <View style={styles.button}>
          ...
          <TouchableOpacity style={styles.icon} onPress={() => { setConfirmNewPassword(''); }}>
            <Image source={xIcon} />
          </TouchableOpacity>
        </View>
